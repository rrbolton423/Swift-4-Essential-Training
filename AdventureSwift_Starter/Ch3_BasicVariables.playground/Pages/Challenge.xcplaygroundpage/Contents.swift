 ...
 */
// 1
var characterName = "Romell", characterClass = "King"
// 2
characterName += " Bolton"
// 3
var hpPercentDouble = 75.53
// 4
var hpPercentInt = Int(hpPercentDouble)
// 5
var playerString = "\(characterName) has \(hpPercentInt) hp left"
// 6
print(playerString)
// 7
var isAlive = true
// 8
playerString.append(", isAlive? = \(isAlive)")
print(playerString)
